(function applyAppBrand() {
  ...
  document.querySelectorAll(".md-sidebar--primary .md-nav__item--section").forEach((section) => {
    ...
    section.hidden = (app === "fieldwas" && isSmartDurationSection) || (app === "smart-duration" && isFieldWasSection);
  });
}());
